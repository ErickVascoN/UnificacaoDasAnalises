...
from utils.lencol_caseamento import (
...
# lencol_classifica_jogo_fundo / _lencol_tipos_tams / lencol_caseamento vêm de
# utils/lencol_caseamento.py (compartilhado com a geração de PDF em
# pages/10_Relatorios.py — mantém as duas telas sempre consistentes).
